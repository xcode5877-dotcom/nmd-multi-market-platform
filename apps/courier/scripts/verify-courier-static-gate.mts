...
assert(!bundle.includes('x-api-key'), 'x-api-key must not ship in Courier assets');
assert(!bundle.includes('c522d724baaaf9a3213dcf17590f0fd8'), 'leaked API key absent from assets');
